...
<head>
  ...
  <title>DDC&GH- Admin login</title>
                ...
                <div class="p-5">
                  ...
                  <form class="user" action="" method="POST">
                    <div class="form-group">
                      <input type="text" name="username" class="form-control form-control-user" id="" placeholder="Enter User Name...">
                    </div>
                    <div class="form-group">
